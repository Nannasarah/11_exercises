...
function isCat(animal) {
  // samme som en if sætning bare kortere
...
function selectSort(event) {
  ...
  const oldElemenet = document.querySelector(`[data-sort ='${settings.sortBy}']`);
  oldElemenet.classList.remove("sortby");

  // indeicate active sort
